...
$(document).ready(function () {$('.user_big_avatar>.avatar').identicon5({size:40});$('.user_avatar>.avatar').identicon5({size:30});$('.user_card .user_avatar>.avatar').identicon5({size:48});});